...
namespace ScheduledTAsks
{
    public class FirstDeadline
    {
        ...
        private void ManUpGroupsSecondly(int course, int semestr)
        {
            ...
            var onceRegisteredStd = students.Where(s => s.Disciplines?.Count == 1).ToList();
        ...
        private void manUpGroupsFirstly(int course, int semestr)
        {
            ...
            var notRegisteredStd = students.Where(s => s.Disciplines == null ||
                                                       s.Disciplines.Count == 0).ToList();
